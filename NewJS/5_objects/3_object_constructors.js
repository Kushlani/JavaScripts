...
//following is a valid object creation
var studentObj = {
	name: "Student name",
 ...
 *
 * THIS KEYWORD INDICATES THAT IT BELONGS TO THAT OBJET.
 *
 * OBJECT CONSTUCTORS ARE FOCUSED ON OBJECT CREATION, WHATEVER YOU PUT INSIDE THE OBJECT CONSTRUCTORS WILL BE A PART OF ALL THE 
 * OBJECTS WHICH ARE CREATED BY IT.
 *
 * Very important
 *
 * OBJECT PROPERTIES ARE ACCESSSED WITH DOT NOTATION (AND WITH ARRAY STYLE ALSO)
 * FORMAT > 	objectReferenceVariable.property
 * But if the access of the object properties within the object itself (if we access the properties within the object constructor)
 * 			    this.property (here this means this instance/this object (what ever the object which get created from the 
 * 			    constructor)).
 *
 * 				Function Constructor is like the Class
 * 				Objects created from the constructor are like object instances. (instance == object)
 * 
